            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {{ __('Before proceeding, please check the verification link in your email. If you did not receive the email') }}, <a href="{{ route('resend.verify.email') }}" class="link-primary">{{ __('click here to request another') }}</a>
                        </div>
                    </div>
                </div>
            </div>
